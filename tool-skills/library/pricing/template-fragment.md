<!--
  template-fragment: pricing → fills {#pricing} (Step 3, quantified at Step 4)
  Follow process/CONVENTIONS.md. ⚙️ = agent proposal awaiting approval.
-->

## Pricing & Packaging {#pricing}

_What we charge and how we package it — anchored to value vs the alternative, not to cost. Price
points feed `unit-economics` (margin check) and `financial-model` (projection)._
