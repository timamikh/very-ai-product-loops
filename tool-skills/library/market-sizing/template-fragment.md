<!--
  template-fragment: market-sizing → fills {#market-sizing}
...
|------------|-------|--------|------------|------------|
| e.g. reachable accounts | … | … | [sourced: …] / [assumption] | H-… (viability) |
| e.g. price per period | … | … | [assumption] | H-… (viability) |
| e.g. adoption / share | … | … | [assumption] | H-… (viability) |

<!-- card -->
**Sizing read:** <one sentence — the SAM (the load-bearing number), what it rests on, and what it
means for the concept's viability>.

**Seeded registers:** H-… (sizing assumption, `type: viability`) → registers.
