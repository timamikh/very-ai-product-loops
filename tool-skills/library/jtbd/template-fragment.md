...
### At Step 3 — this becomes `{#bets}`

Each bet is a strategic wager framed on the job: _we bet that <segment> will hire us over
<status quo> for <the job> because <pull beats anxiety + habit>._ Seed one `H-…` per bet.
