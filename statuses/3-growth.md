...
per_step:
  "1":  # Concept
    ...
    tools: [segmentation, value-definition-concept]
  "2":  # Analysis
    goals:
  ...
  "3":  # Strategy
    ...
    tools: [where-to-play-how-to-win, value-definition-strategy, pricing-strategy, channels-expansion, uvp-cpv, pre-mortem]
  "4":  # Strategic Plan
    goals:
  ...
  "5":  # Tactical Plan
    ...
    tools: [prioritization-tactical-plan, goal-targets, guardrails, segment-cvp, hypothesis-test-design, experiment-readout, resource-check]
  "6":  # Sprint Plan
    goals:
