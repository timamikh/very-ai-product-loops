...
| **Microsoft 365 Copilot** | per-seat add-on | **$18/user/mo** annual (promo, reg. $21) + qualifying M365 base | native pptx (runs in PowerPoint) | [sourced: microsoft.com pricing, high] |
...
**~$20–40/mo/seat**; Microsoft's bundle at **$18/seat** *on top of* an M365 licence users already
buy. **Blended market anchor ⚙️ ≈ $15/mo = $180/yr/seat** (used in `market-sizing.md`). The bundle
