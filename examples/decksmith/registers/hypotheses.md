...
|----|------------|------|--------|------|--------|------|------------|
| H-001 | The engine can reliably produce native files that are both genuinely editable **and** genuinely well-designed, at scale | feasibility | **testing** | Step 1 | concept (`../passport.md#concept`) | **Step 4:** `M-edit-fidelity` ≥ 90% (fail < 70%) · **Step 5:** 20 test decks, decision rule set (`../tactical-plan.md#hypotheses-to-test`) · **Step 6:** `F-1`+`T-1` produce first read (`../sprint-plan.md#must`) | [assumption] |
