...
| H-007 | For the beachhead job, "actually-editable + designed native decks" is a strong enough wedge that salespeople & marketers switch (pull beats the "I'll still have to fix it" anxiety + PowerPoint habit) | desirability | open | Step 3 | bets (`../strategy.md#bets`); job/forces (`../passport.md#jtbd`) | demand test framed on "actually editable" (Step 5) | [assumption] |
...
| H-009 | The beachhead will pay a standalone subscription (~$15–25) despite incumbents bundling | viability | open | Step 3 | pricing (`../strategy.md#pricing`) | WTP / price talk / pilot (Step 5) | [assumption] |
