...
|----|------------|------|--------|------|--------|------|------------|
| H-001 | The engine can reliably produce native files that are both genuinely editable **and** genuinely well-designed, at scale | feasibility | open | Step 1 | concept (`../passport.md#concept`) | **Step 4:** `M-edit-fidelity` ≥ 90% (fail < 70%); test design Step 5/6 | [assumption] |
